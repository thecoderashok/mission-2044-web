...
const SwiperCarousel = ({
    ...
    useEffect(() => {
        ...
        if (!swiper || !navigationBtns) return;
        ...
        if (swiper.navigation) {
            // reset to avoid duplicate listeners
            if (swiper.navigation.destroy) swiper.navigation.destroy();
            if (swiper.navigation.init) swiper.navigation.init();
            if (swiper.navigation.update) swiper.navigation.update();
        }
    }, [navigationBtns]);
    ...
    return (
        <div className="carousel-wrapper">
            <Swiper
                ...
                speed={speed}
                navigation={navigationBtns ? true : false}
