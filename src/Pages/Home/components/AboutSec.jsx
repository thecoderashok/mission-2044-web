                        ...
                        <div className="text-wrapper">
                            ...
                            <ScrollReveal direction="clip-fade-up" delay={0.3}>
                                <p className="size-large">
                                    This is the community shaping the future of Defense Innovation
                                    and Resilience. <br /> <b>MISSION 2044</b> is the premier
                                    global event series at the intersection of Defense Innovation,
                                    Civil and Industrial Resilience, and Critical Infrastructure.
                                </p>
                            </ScrollReveal>
                            ...
                            <ScrollReveal direction="clip-fade-up" delay={0.35}>
                                <p>
                                    ...
                                    thought leaders from allied nations to accelerate innovation,
                                    strengthen supply chains, and build resilience across the
                                    ecosystems that underpin our security.
                                </p>
                            </ScrollReveal>
